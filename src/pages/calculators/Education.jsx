...
import { GraduationCap, IndianRupee, Percent, Calendar, Download, Share2, Info, Users } from 'lucide-react';
...
import { calculateEducation, getEducationBreakdown } from '../../utils/educationFormula';
...
const Education = () => {
  ...
  useEffect(() => {
    // Ensure education age is greater than current age
    const validEducationAge = Math.max(currentAge + 1, educationAge);
    if (validEducationAge !== educationAge) {
      setEducationAge(validEducationAge);
    } else {
      const res = calculateEducation(currentAge, educationAge, currentExpense, returnRate, inflationRate);
      setResults(res);
      setBreakdown(getEducationBreakdown(currentAge, educationAge, currentExpense, returnRate, inflationRate));
    }
  }, [currentAge, educationAge, currentExpense, returnRate, inflationRate]);
    ...
    <div className="pt-24 pb-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="mb-10">
        <nav className="flex mb-4 text-sm font-medium text-gray-500 dark:text-gray-400">
          <ol className="flex items-center space-x-2">
            ...
            <li><span>/</span></li>
            <li className="text-emerald-600 dark:text-emerald-400">Education Planning</li>
          </ol>
        </nav>
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-2">
          Plan for your child's higher education by estimating future costs and required investments.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        >
          ...
          <div className="mt-12 p-6 bg-orange-50 dark:bg-orange-500/10 rounded-2xl border border-orange-100 dark:border-orange-500/20">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <span className="text-gray-600 dark:text-gray-400">Current Education Expenses</span>
                <span className="text-gray-900 dark:text-gray-100 font-bold">{formatCurrency(currentExpense)}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600 dark:text-gray-400">Future Education Expenses</span>
                <span className="text-gray-900 dark:text-gray-100 font-bold">{formatCurrency(results.futureExpense)}</span>
              </div>
              <div className="h-px bg-orange-200 dark:bg-orange-500/20" />
              <div className="flex justify-between items-center">
                <span className="text-gray-800 dark:text-gray-200 font-bold">Planning Through Lumpsum</span>
                <span className="text-orange-600 dark:text-orange-400 font-bold">{formatCurrency(results.lumpsumRequired)}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-800 dark:text-gray-200 font-bold">Planning Through SIP</span>
                <span className="text-orange-600 dark:text-orange-400 text-xl font-black">{formatCurrency(results.sipRequired)} /mo</span>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-sm flex flex-col items-center">
              ...
              <PieChart 
                ...
                labels={['Current Education Expenses', 'Future Education Expenses']} 
            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-sm flex flex-col justify-center">
              <h3 className="text-gray-700 dark:text-gray-200 font-bold mb-6">Education Planning Comparison</h3>
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <div className="w-3 h-12 bg-blue-500 rounded-full" />
                  <div>
                    <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">Future Education Expenses</p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">Current Education Expenses</p>
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-sm">
            <div className="flex justify-between items-center mb-8">
              <h3 className="text-gray-700 dark:text-gray-200 font-bold">Education Planning Comparison</h3>
              <div className="flex gap-2">
                <button className="p-2 bg-gray-100 dark:bg-gray-700 rounded-lg hover:text-orange-500 transition-colors"><Share2 className="w-5 h-5" /></button>
              </div>
            </div>
            <InvestmentChart 
              breakdown={breakdown} 
              dataKeys={['projectedExpense', 'currentExpense']} 
              dataLabels={['Future Education Expenses', 'Current Education Expenses']} 
              stacked={false}
              labelPrefix=""
            />
          </div>
